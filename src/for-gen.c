...
static uint32_t pack0_n(uint32_t base, const uint32_t *in, uint8_t *out) {
  (void)base;
  (void)in;
  (void)out;
  return 0;
...
static uint32_t unpack0_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  int k;
  (void)in;
  for (k = 0; k < 32; ++k) {
    out[k] = base;
...
static uint32_t unpack0_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  int k;
  (void)in;
  for (k = 0; k < 16; ++k) {
    out[k] = base;
...
static uint32_t unpack0_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  int k;
  (void)in;
  for (k = 0; k < 8; ++k) {
    out[k] = base;
...
static uint32_t pack0_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  (void)base;
  (void)in;
  (void)out;
...
static uint32_t unpack0_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t k;
  (void)in;
  for (k = 0; k < length; ++k) {
...
static uint32_t linsearch0_n(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  (void)in;
  if (base == value)
    *found = 0;
...
static uint32_t linsearch0_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  (void)in;
...
static uint32_t pack1_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 1;
  tmp |= (*(in + 2) - base) << 2;
...
static uint32_t unpack1_32(uint32_t base, const uint8_t *in, uint32_t *out) {
...
static uint32_t pack2_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 2;
  tmp |= (*(in + 2) - base) << 4;
...
static uint32_t unpack2_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 3);
...
static uint32_t pack3_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 3;
  tmp |= (*(in + 2) - base) << 6;
...
static uint32_t unpack3_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 7);
...
static uint32_t pack4_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 4;
  tmp |= (*(in + 2) - base) << 8;
...
static uint32_t unpack4_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack5_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 5;
  tmp |= (*(in + 2) - base) << 10;
...
static uint32_t unpack5_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack6_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 6;
  tmp |= (*(in + 2) - base) << 12;
...
static uint32_t unpack6_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack7_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 7;
  tmp |= (*(in + 2) - base) << 14;
...
static uint32_t unpack7_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack8_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 8;
  tmp |= (*(in + 2) - base) << 16;
...
static uint32_t unpack8_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack9_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 9;
  tmp |= (*(in + 2) - base) << 18;
...
static uint32_t unpack9_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack10_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 10;
  tmp |= (*(in + 2) - base) << 20;
...
static uint32_t unpack10_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack11_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 11;
  tmp |= (*(in + 2) - base) << 22;
...
static uint32_t unpack11_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack12_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 12;
  tmp |= (*(in + 2) - base) << 24;
...
static uint32_t unpack12_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack13_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 13;
  tmp |= (*(in + 2) - base) << 26;
...
static uint32_t unpack13_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack14_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 14;
  tmp |= (*(in + 2) - base) << 28;
...
static uint32_t unpack14_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack15_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 15;
  tmp |= (*(in + 2) - base) << 30;
...
static uint32_t unpack15_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack16_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 16;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack16_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack17_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 17;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack17_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack18_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 18;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack18_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack19_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 19;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack19_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack20_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 20;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack20_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack21_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 21;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack21_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack22_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 22;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack22_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack23_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 23;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack23_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack24_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 24;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack24_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack25_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 25;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack25_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack26_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 26;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack26_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack27_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 27;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack27_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack28_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 28;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack28_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack29_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 29;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack29_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack30_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 30;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack30_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack31_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 31;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack31_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
...
static uint32_t pack32_32(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t i;
...
static uint32_t unpack32_32(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t i;
  uint32_t *in32 = (uint32_t *)in;
  for (i = 0; i < 32; i++)
    out[i] = base + in32[i];
...
for_packfunc_t for_pack32[33] = {
    pack0_n,   pack1_32,  pack2_32,  pack3_32,  pack4_32,  pack5_32,  pack6_32,
    pack7_32,  pack8_32,  pack9_32,  pack10_32, pack11_32, pack12_32, pack13_32,
    pack14_32, pack15_32, pack16_32, pack17_32, pack18_32, pack19_32, pack20_32,
    pack21_32, pack22_32, pack23_32, pack24_32, pack25_32, pack26_32, pack27_32,
    pack28_32, pack29_32, pack30_32, pack31_32, pack32_32};

for_unpackfunc_t for_unpack32[33] = {
    unpack0_32,  unpack1_32,  unpack2_32,  unpack3_32,  unpack4_32,
...
static uint32_t pack1_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 1;
  tmp |= (*(in + 2) - base) << 2;
...
static uint32_t unpack1_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1);
...
static uint32_t pack2_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 2;
  tmp |= (*(in + 2) - base) << 4;
...
static uint32_t unpack2_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 3);
...
static uint32_t pack3_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 3;
  tmp |= (*(in + 2) - base) << 6;
...
static uint32_t unpack3_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 7);
...
static uint32_t pack4_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 4;
  tmp |= (*(in + 2) - base) << 8;
...
static uint32_t unpack4_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 15);
...
static uint32_t pack5_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 5;
  tmp |= (*(in + 2) - base) << 10;
...
static uint32_t unpack5_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 31);
...
static uint32_t pack6_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 6;
  tmp |= (*(in + 2) - base) << 12;
...
static uint32_t unpack6_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 63);
...
static uint32_t pack7_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 7;
  tmp |= (*(in + 2) - base) << 14;
...
static uint32_t unpack7_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 127);
...
static uint32_t pack8_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 8;
  tmp |= (*(in + 2) - base) << 16;
...
static uint32_t unpack8_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 255);
...
static uint32_t pack9_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 9;
  tmp |= (*(in + 2) - base) << 18;
...
static uint32_t unpack9_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 511);
...
static uint32_t pack10_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 10;
  tmp |= (*(in + 2) - base) << 20;
...
static uint32_t unpack10_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1023);
...
static uint32_t pack11_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 11;
  tmp |= (*(in + 2) - base) << 22;
...
static uint32_t unpack11_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 2047);
...
static uint32_t pack12_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 12;
  tmp |= (*(in + 2) - base) << 24;
...
static uint32_t unpack12_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 4095);
...
static uint32_t pack13_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 13;
  tmp |= (*(in + 2) - base) << 26;
...
static uint32_t unpack13_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 8191);
...
static uint32_t pack14_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 14;
  tmp |= (*(in + 2) - base) << 28;
...
static uint32_t unpack14_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 16383);
...
static uint32_t pack15_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 15;
  tmp |= (*(in + 2) - base) << 30;
...
static uint32_t unpack15_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 32767);
...
static uint32_t pack16_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 16;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack16_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 65535);
...
static uint32_t pack17_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 17;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack17_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 131071);
...
static uint32_t pack18_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 18;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack18_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 262143);
...
static uint32_t pack19_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 19;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack19_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 524287);
...
static uint32_t pack20_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 20;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack20_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1048575);
...
static uint32_t pack21_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 21;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack21_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 2097151);
...
static uint32_t pack22_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 22;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack22_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 4194303);
...
static uint32_t pack23_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 23;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack23_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 8388607);
...
static uint32_t pack24_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 24;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack24_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 16777215);
...
static uint32_t pack25_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 25;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack25_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 33554431);
...
static uint32_t pack26_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 26;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack26_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 67108863);
...
static uint32_t pack27_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 27;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack27_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 134217727);
...
static uint32_t pack28_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 28;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack28_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 268435455);
...
static uint32_t pack29_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 29;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack29_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 536870911);
...
static uint32_t pack30_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 30;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack30_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1073741823);
...
static uint32_t pack31_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 31;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack31_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 2147483647);
...
static uint32_t pack32_16(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t i;
  uint32_t *out32 = (uint32_t *)out;
  for (i = 0; i < 16; i++)
    out32[i] = in[i] - base;
...
static uint32_t unpack32_16(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t i;
  uint32_t *in32 = (uint32_t *)in;
  for (i = 0; i < 16; i++)
    out[i] = base + in32[i];
...
for_packfunc_t for_pack16[33] = {
    pack0_n,   pack1_16,  pack2_16,  pack3_16,  pack4_16,  pack5_16,  pack6_16,
    pack7_16,  pack8_16,  pack9_16,  pack10_16, pack11_16, pack12_16, pack13_16,
    pack14_16, pack15_16, pack16_16, pack17_16, pack18_16, pack19_16, pack20_16,
    pack21_16, pack22_16, pack23_16, pack24_16, pack25_16, pack26_16, pack27_16,
    pack28_16, pack29_16, pack30_16, pack31_16, pack32_16};

for_unpackfunc_t for_unpack16[33] = {
    unpack0_16,  unpack1_16,  unpack2_16,  unpack3_16,  unpack4_16,
    unpack5_16,  unpack6_16,  unpack7_16,  unpack8_16,  unpack9_16,
    unpack10_16, unpack11_16, unpack12_16, unpack13_16, unpack14_16,
    unpack15_16, unpack16_16, unpack17_16, unpack18_16, unpack19_16,
    unpack20_16, unpack21_16, unpack22_16, unpack23_16, unpack24_16,
    unpack25_16, unpack26_16, unpack27_16, unpack28_16, unpack29_16,
    unpack30_16, unpack31_16, unpack32_16};

static uint32_t pack1_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 1;
  tmp |= (*(in + 2) - base) << 2;
...
static uint32_t unpack1_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1);
...
static uint32_t pack2_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 2;
  tmp |= (*(in + 2) - base) << 4;
...
static uint32_t unpack2_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 3);
...
static uint32_t pack3_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 3;
  tmp |= (*(in + 2) - base) << 6;
...
static uint32_t unpack3_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 7);
...
static uint32_t pack4_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 4;
  tmp |= (*(in + 2) - base) << 8;
...
static uint32_t unpack4_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 15);
...
static uint32_t pack5_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 5;
  tmp |= (*(in + 2) - base) << 10;
...
static uint32_t unpack5_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 31);
...
static uint32_t pack6_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 6;
  tmp |= (*(in + 2) - base) << 12;
...
static uint32_t unpack6_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 63);
...
static uint32_t pack7_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 7;
  tmp |= (*(in + 2) - base) << 14;
...
static uint32_t unpack7_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 127);
...
static uint32_t pack8_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 8;
  tmp |= (*(in + 2) - base) << 16;
...
static uint32_t unpack8_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 255);
...
static uint32_t pack9_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 9;
  tmp |= (*(in + 2) - base) << 18;
...
static uint32_t unpack9_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 511);
...
static uint32_t pack10_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 10;
  tmp |= (*(in + 2) - base) << 20;
...
static uint32_t unpack10_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1023);
...
static uint32_t pack11_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 11;
  tmp |= (*(in + 2) - base) << 22;
...
static uint32_t unpack11_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 2047);
...
static uint32_t pack12_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 12;
  tmp |= (*(in + 2) - base) << 24;
...
static uint32_t unpack12_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 4095);
...
static uint32_t pack13_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 13;
  tmp |= (*(in + 2) - base) << 26;
...
static uint32_t unpack13_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 8191);
...
static uint32_t pack14_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 14;
  tmp |= (*(in + 2) - base) << 28;
...
static uint32_t unpack14_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 16383);
...
static uint32_t pack15_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 15;
  tmp |= (*(in + 2) - base) << 30;
...
static uint32_t unpack15_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 32767);
...
static uint32_t pack16_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 16;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack16_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 65535);
...
static uint32_t pack17_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 17;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack17_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 131071);
...
static uint32_t pack18_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 18;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack18_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 262143);
...
static uint32_t pack19_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 19;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack19_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 524287);
...
static uint32_t pack20_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 20;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack20_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1048575);
...
static uint32_t pack21_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 21;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack21_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 2097151);
...
static uint32_t pack22_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 22;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack22_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 4194303);
...
static uint32_t pack23_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 23;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack23_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 8388607);
...
static uint32_t pack24_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 24;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack24_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 16777215);
...
static uint32_t pack25_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 25;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack25_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 33554431);
...
static uint32_t pack26_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 26;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack26_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 67108863);
...
static uint32_t pack27_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 27;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack27_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 134217727);
...
static uint32_t pack28_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 28;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack28_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 268435455);
...
static uint32_t pack29_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 29;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack29_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 536870911);
...
static uint32_t pack30_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 30;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack30_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 1073741823);
...
static uint32_t pack31_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t tmp, length;
  tmp = (*(in + 0) - base) << 0;
  tmp |= (*(in + 1) - base) << 31;
  *(uint32_t *)out = tmp;
...
static uint32_t unpack31_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t *in32 = (uint32_t *)in;
  uint32_t tmp;
  (void)tmp;
  *(out + 0) = base + ((*in32 >> 0) & 2147483647);
...
static uint32_t pack32_8(uint32_t base, const uint32_t *in, uint8_t *out) {
  uint32_t i;
  uint32_t *out32 = (uint32_t *)out;
  for (i = 0; i < 8; i++)
    out32[i] = in[i] - base;
...
static uint32_t unpack32_8(uint32_t base, const uint8_t *in, uint32_t *out) {
  uint32_t i;
  uint32_t *in32 = (uint32_t *)in;
  for (i = 0; i < 8; i++)
    out[i] = base + in32[i];
...
for_packfunc_t for_pack8[33] = {
    pack0_n,  pack1_8,  pack2_8,  pack3_8,  pack4_8,  pack5_8,  pack6_8,
    pack7_8,  pack8_8,  pack9_8,  pack10_8, pack11_8, pack12_8, pack13_8,
    pack14_8, pack15_8, pack16_8, pack17_8, pack18_8, pack19_8, pack20_8,
    pack21_8, pack22_8, pack23_8, pack24_8, pack25_8, pack26_8, pack27_8,
    pack28_8, pack29_8, pack30_8, pack31_8, pack32_8};

for_unpackfunc_t for_unpack8[33] = {
    unpack0_8,  unpack1_8,  unpack2_8,  unpack3_8,  unpack4_8,  unpack5_8,
    unpack6_8,  unpack7_8,  unpack8_8,  unpack9_8,  unpack10_8, unpack11_8,
    unpack12_8, unpack13_8, unpack14_8, unpack15_8, unpack16_8, unpack17_8,
    unpack18_8, unpack19_8, unpack20_8, unpack21_8, unpack22_8, unpack23_8,
    unpack24_8, unpack25_8, unpack26_8, unpack27_8, unpack28_8, unpack29_8,
    unpack30_8, unpack31_8, unpack32_8};

static uint32_t pack1_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
...
static uint32_t unpack1_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack2_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack2_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack3_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack3_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack4_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack4_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack5_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack5_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack6_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack6_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack7_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack7_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack8_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack8_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack9_x(uint32_t base, const uint32_t *in, uint8_t *out,
                        uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack9_x(uint32_t base, const uint8_t *in, uint32_t *out,
                          uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack10_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack10_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack11_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack11_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack12_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack12_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack13_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack13_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack14_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack14_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack15_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack15_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack16_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack16_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack17_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack17_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack18_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack18_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack19_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack19_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack20_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack20_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack21_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack21_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack22_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack22_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack23_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack23_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack24_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack24_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack25_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack25_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack26_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack26_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack27_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack27_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack28_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack28_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack29_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack29_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack30_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack30_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack31_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack31_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
static uint32_t pack32_x(uint32_t base, const uint32_t *in, uint8_t *out,
                         uint32_t length) {
  uint32_t tmp, remaining;
  if (length == 0)
    return 0;
...
static uint32_t unpack32_x(uint32_t base, const uint8_t *in, uint32_t *out,
                           uint32_t length) {
  uint32_t tmp;
  if (length == 0)
    return 0;
...
for_packxfunc_t for_packx[33] = {
    pack0_x,  pack1_x,  pack2_x,  pack3_x,  pack4_x,  pack5_x,  pack6_x,
    pack7_x,  pack8_x,  pack9_x,  pack10_x, pack11_x, pack12_x, pack13_x,
    pack14_x, pack15_x, pack16_x, pack17_x, pack18_x, pack19_x, pack20_x,
    pack21_x, pack22_x, pack23_x, pack24_x, pack25_x, pack26_x, pack27_x,
    pack28_x, pack29_x, pack30_x, pack31_x, pack32_x};

for_unpackxfunc_t for_unpackx[33] = {
    unpack0_x,  unpack1_x,  unpack2_x,  unpack3_x,  unpack4_x,  unpack5_x,
    unpack6_x,  unpack7_x,  unpack8_x,  unpack9_x,  unpack10_x, unpack11_x,
    unpack12_x, unpack13_x, unpack14_x, unpack15_x, unpack16_x, unpack17_x,
    unpack18_x, unpack19_x, unpack20_x, unpack21_x, unpack22_x, unpack23_x,
    unpack24_x, unpack25_x, unpack26_x, unpack27_x, unpack28_x, unpack29_x,
    unpack30_x, unpack31_x, unpack32_x};

static uint32_t linsearch1_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch2_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch3_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch4_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch5_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch6_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch7_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch8_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch9_32(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch10_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch11_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch12_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch13_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch14_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch15_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch16_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch17_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch18_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch19_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch20_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch21_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch22_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch23_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch24_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch25_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch26_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch27_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch28_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch29_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch30_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch31_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch32_32(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t i;
  uint32_t *in32 = (uint32_t *)in;
  value -= base;
...
for_linsearchfunc_t for_linsearch32[33] = {
    linsearch0_n,   linsearch1_32,  linsearch2_32,  linsearch3_32,
    linsearch4_32,  linsearch5_32,  linsearch6_32,  linsearch7_32,
    linsearch8_32,  linsearch9_32,  linsearch10_32, linsearch11_32,
    linsearch12_32, linsearch13_32, linsearch14_32, linsearch15_32,
    linsearch16_32, linsearch17_32, linsearch18_32, linsearch19_32,
    linsearch20_32, linsearch21_32, linsearch22_32, linsearch23_32,
    linsearch24_32, linsearch25_32, linsearch26_32, linsearch27_32,
    linsearch28_32, linsearch29_32, linsearch30_32, linsearch31_32,
    linsearch32_32};

static uint32_t linsearch1_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch2_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch3_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch4_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch5_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch6_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch7_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch8_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch9_16(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch10_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch11_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch12_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch13_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch14_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch15_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch16_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch17_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch18_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch19_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch20_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch21_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch22_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch23_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch24_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch25_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch26_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch27_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch28_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch29_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch30_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch31_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch32_16(uint32_t base, const uint8_t *in, uint32_t value,
                               int *found) {
  uint32_t i;
  uint32_t *in32 = (uint32_t *)in;
  value -= base;
...
for_linsearchfunc_t for_linsearch16[33] = {
    linsearch0_n,   linsearch1_16,  linsearch2_16,  linsearch3_16,
    linsearch4_16,  linsearch5_16,  linsearch6_16,  linsearch7_16,
    linsearch8_16,  linsearch9_16,  linsearch10_16, linsearch11_16,
    linsearch12_16, linsearch13_16, linsearch14_16, linsearch15_16,
    linsearch16_16, linsearch17_16, linsearch18_16, linsearch19_16,
    linsearch20_16, linsearch21_16, linsearch22_16, linsearch23_16,
    linsearch24_16, linsearch25_16, linsearch26_16, linsearch27_16,
    linsearch28_16, linsearch29_16, linsearch30_16, linsearch31_16,
    linsearch32_16};

static uint32_t linsearch1_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch2_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch3_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch4_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch5_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch6_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch7_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch8_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch9_8(uint32_t base, const uint8_t *in, uint32_t value,
                             int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch10_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch11_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch12_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch13_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch14_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch15_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch16_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch17_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch18_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch19_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch20_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch21_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch22_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch23_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch24_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch25_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch26_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch27_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch28_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch29_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch30_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch31_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t tmp, tmp2;
  value -= base;
  (void)tmp2;
...
static uint32_t linsearch32_8(uint32_t base, const uint8_t *in, uint32_t value,
                              int *found) {
  uint32_t i;
  uint32_t *in32 = (uint32_t *)in;
  value -= base;
...
for_linsearchfunc_t for_linsearch8[33] = {
    linsearch0_n,  linsearch1_8,  linsearch2_8,  linsearch3_8,  linsearch4_8,
    linsearch5_8,  linsearch6_8,  linsearch7_8,  linsearch8_8,  linsearch9_8,
    linsearch10_8, linsearch11_8, linsearch12_8, linsearch13_8, linsearch14_8,
    linsearch15_8, linsearch16_8, linsearch17_8, linsearch18_8, linsearch19_8,
    linsearch20_8, linsearch21_8, linsearch22_8, linsearch23_8, linsearch24_8,
    linsearch25_8, linsearch26_8, linsearch27_8, linsearch28_8, linsearch29_8,
    linsearch30_8, linsearch31_8, linsearch32_8};

static uint32_t linsearch1_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch2_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch3_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch4_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch5_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch6_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch7_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch8_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch9_x(uint32_t base, const uint8_t *in, uint32_t length,
                             uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch10_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch11_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch12_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch13_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch14_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch15_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch16_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch17_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch18_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch19_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch20_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch21_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch22_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch23_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch24_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch25_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch26_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch27_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch28_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch29_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch30_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch31_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
static uint32_t linsearch32_x(uint32_t base, const uint8_t *in, uint32_t length,
                              uint32_t value, int *found) {
  uint32_t tmp, tmp2;
  (void)tmp2;
  if (length == 0)
...
for_linsearchxfunc_t for_linsearchx[33] = {
    linsearch0_x,  linsearch1_x,  linsearch2_x,  linsearch3_x,  linsearch4_x,
    linsearch5_x,  linsearch6_x,  linsearch7_x,  linsearch8_x,  linsearch9_x,
    linsearch10_x, linsearch11_x, linsearch12_x, linsearch13_x, linsearch14_x,
    linsearch15_x, linsearch16_x, linsearch17_x, linsearch18_x, linsearch19_x,
    linsearch20_x, linsearch21_x, linsearch22_x, linsearch23_x, linsearch24_x,
    linsearch25_x, linsearch26_x, linsearch27_x, linsearch28_x, linsearch29_x,
    linsearch30_x, linsearch31_x, linsearch32_x};
