...
// Returns the index
size_t findlowerbound(const uint32_t *in,  uint32_t key,
        uint32_t *presult) {
    selectmetadata s;
    s.length = *in;
    in ++;
...
static int search1_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {

    *decoded = ( (*in) >>  0  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  0 ;
    *decoded = ( (*in) >>  1  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  1 ;
    *decoded = ( (*in) >>  2  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  2 ;
    *decoded = ( (*in) >>  3  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  3 ;
    *decoded = ( (*in) >>  4  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  4 ;
    *decoded = ( (*in) >>  5  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  5 ;
    *decoded = ( (*in) >>  6  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  6 ;
    *decoded = ( (*in) >>  7  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  7 ;
    *decoded = ( (*in) >>  8  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  8 ;
    *decoded = ( (*in) >>  9  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  9 ;
    *decoded = ( (*in) >>  10  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  10 ;
    *decoded = ( (*in) >>  11  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  11 ;
    *decoded = ( (*in) >>  12  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  12 ;
    *decoded = ( (*in) >>  13  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  13 ;
    *decoded = ( (*in) >>  14  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  14 ;
    *decoded = ( (*in) >>  15  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  15 ;
    *decoded = ( (*in) >>  16  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  16 ;
    *decoded = ( (*in) >>  17  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  17 ;
    *decoded = ( (*in) >>  18  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  18 ;
    *decoded = ( (*in) >>  19  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  19 ;
    *decoded = ( (*in) >>  20  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  20 ;
    *decoded = ( (*in) >>  21  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  21 ;
    *decoded = ( (*in) >>  22  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  22 ;
    *decoded = ( (*in) >>  23  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  23 ;
    *decoded = ( (*in) >>  24  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  24 ;
    *decoded = ( (*in) >>  25  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  25 ;
    *decoded = ( (*in) >>  26  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  26 ;
    *decoded = ( (*in) >>  27  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  27 ;
    *decoded = ( (*in) >>  28  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  28 ;
    *decoded = ( (*in) >>  29  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  29 ;
    *decoded = ( (*in) >>  30  )   & 1  ;
    *decoded += base;
    if(*decoded >= target) return  30 ;
    *decoded = ( (*in) >>  31  ) ;
    ++in;
    *decoded += base;
    if(*decoded >= target) return  31 ;
     return -1;
...
static int search2_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search3_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search4_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search5_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search6_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search7_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search8_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search9_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search10_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search11_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search12_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search13_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search14_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search15_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search16_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search17_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search18_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search19_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search20_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search21_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search22_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search23_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search24_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search25_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search26_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search27_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search28_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search29_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search30_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search31_32(uint32_t base, const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
...
static int search32_32(uint32_t , const uint32_t *   in, uint32_t    target, uint32_t * decoded) {
    for(int  k = 0 ; k < 32; ++k) {
    	if(in[k] >= target) {
        	*decoded = in[k];
        	return k;
...
{
   switch (bit) {
    case 0: if(target < base) return -1; else {*presult = base; return 0;}

case 1: return search1_32(base, in,  target, presult);

case 2: return search2_32(base, in,  target, presult);

case 3: return search3_32(base, in,  target, presult);

case 4: return search4_32(base, in,  target, presult);

case 5: return search5_32(base, in,  target, presult);

case 6: return search6_32(base, in,  target, presult);

case 7: return search7_32(base, in,  target, presult);

case 8: return search8_32(base, in,  target, presult);

case 9: return search9_32(base, in,  target, presult);

case 10: return search10_32(base, in,  target, presult);

case 11: return search11_32(base, in,  target, presult);

case 12: return search12_32(base, in,  target, presult);

case 13: return search13_32(base, in,  target, presult);

case 14: return search14_32(base, in,  target, presult);

case 15: return search15_32(base, in,  target, presult);

case 16: return search16_32(base, in,  target, presult);

case 17: return search17_32(base, in,  target, presult);

case 18: return search18_32(base, in,  target, presult);

case 19: return search19_32(base, in,  target, presult);

case 20: return search20_32(base, in,  target, presult);

case 21: return search21_32(base, in,  target, presult);

case 22: return search22_32(base, in,  target, presult);

case 23: return search23_32(base, in,  target, presult);

case 24: return search24_32(base, in,  target, presult);

case 25: return search25_32(base, in,  target, presult);

case 26: return search26_32(base, in,  target, presult);

case 27: return search27_32(base, in,  target, presult);

case 28: return search28_32(base, in,  target, presult);

case 29: return search29_32(base, in,  target, presult);

case 30: return search30_32(base, in,  target, presult);

case 31: return search31_32(base, in,  target, presult);

case 32: return search32_32(base, in,  target, presult);
...
size_t findlower_linear(const uint32_t *in, uint32_t key,
uint32_t *presult) {
    selectmetadata s;
    s.length = *in;
    in ++;
