...
void __integratedfastunpack0(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack1(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack2(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack3(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack4(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack5(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack6(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack7(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack8(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack9(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack10(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack11(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack12(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack13(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack14(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack15(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack16(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack17(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack18(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack19(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack20(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack21(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack22(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack23(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack24(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack25(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack26(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack27(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack28(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack29(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack30(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack31(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
void __integratedfastunpack32(const uint32_t initoffset, const uint32_t *  __restrict__ in, uint32_t *  __restrict__  out);
