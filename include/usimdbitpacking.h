...
void __uSIMD_fastpackwithoutmask0(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask1(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask2(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask3(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask4(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask5(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask6(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask7(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask8(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask9(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask10(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask11(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask12(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask13(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask14(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask15(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask16(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask17(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask18(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask19(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask20(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask21(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask22(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask23(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask24(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask25(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask26(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask27(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask28(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask29(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask30(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask31(const uint32_t * __restrict__, __m128i * __restrict__);
void __uSIMD_fastpackwithoutmask32(const uint32_t * __restrict__, __m128i * __restrict__);
