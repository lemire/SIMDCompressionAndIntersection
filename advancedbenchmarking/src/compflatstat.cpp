...
int main(int argc, char **argv) {
    ...
    try {
        ...
        cout << "# Computing statistics of posting lists from " << postFileName << "... please be patient." << endl;
        ...
        size_t wordQty = 0;
        off_t pos=0;uint32_t qty=0;
        while (grpRead.readNextPosAndQty(pos, qty)) {
          ++wordQty;
          totalQty += qty;
        }
        cout << "Final stat, # of words: " << wordQty << " total # of postings: " << totalQty << endl;
